...
public class UnitTest {
    ...
    // Test withdraw(), isAccepted() and getFee of SavingsAccount
    @org.junit.Test
    public void SavingsAccount_withdraw() {
        SavingsAccount savingsAccount = new SavingsAccount("111111", 10_000_000);
        savingsAccount.withdraw(9_000_000);
        assertEquals(1_000_000.0, savingsAccount.getBalance(), 0);
        savingsAccount.withdraw(60_000.0);
        assertEquals(940_000.0, savingsAccount.getBalance(), 0);
    }
